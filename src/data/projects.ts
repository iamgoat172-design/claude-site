...
export const projects: Project[] = [
  // — Клееный брус —
  {
    ...
    longDescription: [
      "«Поместье Ели» — большой дом из клееного бруса 472 м² на два этажа. В центре — гостиная второго света с панорамным остеклением в пол, наполняющая дом естественным светом и видом на лес.",
    ...
    specs: [
      { label: "Площадь", value: "472 м²" },
      { label: "Этажи", value: "2" },
      { label: "Спальни", value: "5" },
      { label: "Санузлы", value: "4" },
      { label: "Гостиная", value: "второй свет" },
      { label: "Террасы", value: "2 + балконы" },
      { label: "Материал", value: "клееный брус" },
